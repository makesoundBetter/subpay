...
const STATUS_CONFIG: Record<string, { label: string; bg: string; border: string; dot: string }> = {
  NEW:              { label: 'Новая',           bg: '#1a2a4a', border: '#2255cc', dot: '#4488ff' },
  PROCESSING:       { label: 'В работе',        bg: '#1a2a4a', border: '#FFE000', dot: '#4488ff' },
  AWAITING_PAYMENT: { label: 'Ожидает оплаты',  bg: '#2a2200', border: '#FFE000', dot: '#FFE000' },
  PAID:             { label: 'Оплачено',         bg: '#1a2a00', border: '#44cc44', dot: '#FFE000' },
