...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'Выбери период и нажми "Отправить заявку". Это займёт 30 секунд.',
  },
  {
    num: '03',
    title: 'Получи реквизиты',
    desc: 'Менеджер свяжется с тобой в Telegram и пришлёт реквизиты для оплаты.',
  },
  {
    num: '04',
    title: 'Подписка активна',
    desc: 'После оплаты мы активируем подписку. Обычно в течение 1-2 часов.',
  },
]
